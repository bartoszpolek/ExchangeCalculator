...
import com.example.exchange.feature.exchange.data.currency.NetworkFallbackCurrencyListRepository
...
import com.example.exchange.feature.exchange.data.rates.RemoteExchangeRatesRepository
...
abstract class ExchangeDataModule {
    ...
    abstract fun bindCurrencyListRepository(
        repository: NetworkFallbackCurrencyListRepository,
    ...
    abstract fun bindExchangeRatesRepository(
        repository: RemoteExchangeRatesRepository,
